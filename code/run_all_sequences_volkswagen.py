...
#txt_filename_list = ['PD8-files/gtcar1.txt','PD*-files/gtcar2.txt','PD8-files/volkswagen.txt']

basedir_list = ['PD8-files/Volkswagen']
txt_filename_list = ['PD8-files/volkswagen.txt']
...
for i in range(len(basedir_list)):
    ...
    for j in range(len(tracker_types)):
        ...
        out_filename = 'results-volkswagen/' + tracker_type + '_' + str(i) + '.txt'
